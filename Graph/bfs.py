...
def display_grid():
    ...
    for i in range(8):
        for j in range(8):
            if grid[i][j] == 1:
                pygame.draw.rect(screen, (0, 153, 153), (j * 50 + 4, i * 50 + 4, 44, 44))
            elif grid[i][j] == -1:
                pygame.draw.rect(screen, (0, 0, 0), (j * 50 + 4, i * 50 + 4,  44, 44))
            elif grid[i][j] == 2:
                pygame.draw.rect(screen, (255, 0, 0), (j * 50 + 4, i * 50 + 4,  44, 44))
            elif grid[i][j] == 3:
                pygame.draw.rect(screen, (0, 255, 0), (j * 50 + 4, i * 50 + 4,  44, 44))
            elif grid[i][j] == 4:
                pygame.draw.rect(screen, (255, 255, 0), (j * 50 + 4, i * 50 + 4,  44, 44))
            else:
                pygame.draw.rect(screen, (255, 255, 255), (j * 50 + 4, i * 50 + 4,  44, 44))
    update_display()
